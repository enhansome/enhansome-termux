...
* [Termux Float](https://play.google.com/store/apps/details?id=com.termux.window) [Termux Float - Github](https://github.com/termux/termux-float) ⭐ 842 | 🐛 23 | 🌐 Java | 📅 2025-12-12 A Termux add-on app to show the terminal in a floating terminal window.
...
* Open URL from Termux - <https://github.com/termux/termux-packages/issues/166> ⭐ 16,789 | 🐛 1,117 | 🌐 Shell | 📅 2026-08-15

## Android Hacking

* <https://github.com/Hax4us/Tmux-Bunch> ⭐ 219 | 🐛 27 | 🌐 Shell | 📅 2020-04-17 Tmux-Bunch is a first tool for complete apk modding in TERMUX (included :- decompiling , recompiling , signapk , zipalign)
...
* [Awesome-list about Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 16,868 | 🐛 68 | 📅 2024-06-02
* [Awesome-list about Hacking using Termux](https://github.com/may215/awesome-termux-hacking) ⭐ 4,750 | 🐛 67 | 📅 2023-12-14
* [Another list of Termux resources](https://github.com/T4P4N/Awesome-Termux) ⭐ 616 | 🐛 0 | 📅 2023-09-17
